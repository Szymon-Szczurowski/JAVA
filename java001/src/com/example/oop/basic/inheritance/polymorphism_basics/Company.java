package com.example.oop.basic.inheritance.polymorphism_basics;
...
public class Company {
    public static void main(String[] args) {
        ...
        Ceo ceo = new Ceo("Szymon", "Prezes", 20000.0f, "Board", 100);

        Employee worker = ceo;
        worker.doWork();
        worker.printInfo(); // Ceo: Szymon z klasy Ceo, wiązanie dynamiczne

        ceo.signContract();
        ceo.printInfo(); // Ceo: Szymon

        Manager person = ceo;
        person.doWork();
        person.hireEmployee();
        person.printInfo(); // Ceo: Szymon

        Employee person2 = manager;
        person2.printInfo(); // Ceo: Karol
