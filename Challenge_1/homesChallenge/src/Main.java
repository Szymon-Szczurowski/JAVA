...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < homes.length; i++ ) {
            ...
            if (randNum == 0) homes[i] = new Flat("Gdańsk", "długa");
            if (randNum == 1) homes[i] = new House("Warszawa", "cienka", 10.0f);
            if (randNum == 2) homes[i] = new Residence("Gdynia", "arka", 20.0f, 100.0f);
